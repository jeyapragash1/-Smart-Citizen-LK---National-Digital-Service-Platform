      ...
      <div className="bg-gradient-to-b from-gray-50 to-white border-b-2 border-gray-100">
        <div className="max-w-7xl mx-auto p-8">
          <div className="flex items-center justify-between mb-8">
            ...
            <button className="flex items-center gap-2 px-8 py-3 bg-gradient-to-r from-blue-600 to-indigo-600 text-white rounded-2xl font-bold hover:shadow-2xl transition-all duration-300 transform hover:scale-105 shadow-lg">
              <ShoppingCart className="w-5 h-5" />
              Cart
              {cartCount > 0 && (
                <span className="ml-2 px-3 py-1 bg-indigo-200 text-indigo-900 rounded-full text-sm font-black">
                  {cartCount}
                </span>
              )}
            </button>
